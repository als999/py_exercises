...
param=(input("Введите имя параметра {} :".format(sorted(london_co[dev])))).lower()
print (london_co[dev].get(param,"Такого ключа не существует в природе, мерзкий ты богохульник."))
